...
//POST
app.post('/', [verificaToken, verificaAdminRole], function(req, res) {
    let body = req.body;
...
//PUT
app.put('/:id', [verificaToken, verificaAdminRole], function(req, res) {
...
//DELETE
app.delete('/:id', [verificaToken, verificaAdminRole], function(req, res) {
    let id = req.params.id;
    let cambiarEstado = {
        estado: false
    }
